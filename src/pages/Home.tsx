...
const futureProducts: { name: string; desc: string; soon: boolean; href: string }[] = [
  { name: "Monitor Light Bar", desc: "Iluminação para tela sem reflexo", soon: false, href: "/light-bar" },
  { name: "Organizador de Cabos", desc: "Mesa limpa, mente limpa", soon: true, href: "" },
  { name: "Suporte para Headset", desc: "Seu headset sempre à mão", soon: true, href: "" },
];
